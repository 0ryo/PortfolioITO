...
const onEditorReady = (scene: Scene, gizmoManager: GizmoManager) => {
  ...
  if (gizmoManager.gizmos.positionGizmo && gizmoManager.gizmos.positionGizmo.scaleRatio)
    gizmoManager.gizmos.positionGizmo.scaleRatio = 1.2

  if (gizmoManager.gizmos.rotationGizmo && gizmoManager.gizmos.rotationGizmo.scaleRatio)
    gizmoManager.gizmos.rotationGizmo.scaleRatio = 0.5

  if (gizmoManager.gizmos.scaleGizmo && gizmoManager.gizmos.scaleGizmo.scaleRatio)
